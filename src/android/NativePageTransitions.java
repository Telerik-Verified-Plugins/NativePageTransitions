...
public class NativePageTransitions extends CordovaPlugin {
  ...
  final boolean requiresRedraw = Build.VERSION.SDK_INT < 19; // Build.VERSION_CODES.KITKAT
...
//    layout = new ViewAnimator(cordova.getActivity());
  ...
  public boolean execute(String action, JSONArray args, final CallbackContext callbackContext) throws JSONException {
    ...
    // TODO move effects to seperate classes
      ...
      public void run() {
        ...
        cordova.getActivity().runOnUiThread(new Runnable() {
          ...
          public void run() {
            ...
            imageViewAnimation.setDuration(1500);
